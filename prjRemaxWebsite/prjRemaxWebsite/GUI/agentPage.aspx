    ...
    <form id="form1" runat="server">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="welcomePage.aspx"><strong>Home</strong> <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
        ...
        <section>
            ...
            <table class="w-100 table-design">
                ...
                <tr>
                    <td class="text-center" style="border-right:solid">
                        <asp:TextBox ID="TextBox1" runat="server" Width="181px" Height="23px"></asp:TextBox>
                    </td>
                    <td class="text-center" style="border-right:solid">
                        <asp:DropDownList ID="cboGender" runat="server" Width="181px"></asp:DropDownList>
                    </td>
                    <td class="text-center" style="border-right:solid">
                        <asp:DropDownList ID="cboCity" runat="server" Width="181px"></asp:DropDownList>
                    </td>
                    <td class="text-center">
                        <asp:DropDownList ID="cboLanguage" runat="server" Width="181px"></asp:DropDownList>
                    </td>
                </tr>
            </table>
        </section>

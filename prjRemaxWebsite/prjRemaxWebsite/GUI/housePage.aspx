    ...
    <header>
        ...
        <section>
            <table class="w-100 table-design">
                ...
                <tr>
                    <td class="text-center" style="border-right:solid">
                        <asp:DropDownList ID="cboTypeOfResidence" runat="server" Width="181px"></asp:DropDownList>
                    </td>
                    <td class="text-center" style="border-right:solid">
                        <asp:DropDownList ID="cboLocation" runat="server" Width="181px" ></asp:DropDownList>
                    </td>
                    <td class="text-center" style="border-right:solid">
                        <asp:DropDownList ID="cboPrice" runat="server" Width="181px" >
                    ...
                    <td class="text-center">
                        <asp:DropDownList ID="cboNumberOfRooms" runat="server" Width="181px">
                            <asp:ListItem>0</asp:ListItem>
